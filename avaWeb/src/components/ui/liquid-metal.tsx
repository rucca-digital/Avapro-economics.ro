...
>(
    (
        ...
        // With a left icon the pill is intentionally lopsided (tight left, roomy
        // right). Without one, use symmetric padding + centered text so the
        // label is properly centered.
        const sizeStyles = icon
            ...
            : {
                  sm: "py-2 px-6 text-sm justify-center",
                  md: "py-3 px-8 text-base justify-center",
                  lg: "py-4 px-10 text-lg justify-center",
              };
